		...
		<div class="d-inline-block p-3">
			...
			<div class="dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					<li><a href="#">体調の入力</a></li>
					<li><a href="#">ユーザの取り込み</a></li>
	...
	<form method="post" class="pl-3 m-4" style="font-size: 13px">
		...
		<div class="form-group pt-3">
			<input type="text" class="form-control" name="lastUsedTime"
				value="${lastUsedTime}" disabled />
		</div>
		<div class="form-group pt-3">
			<label for="userId">社員番号</label> <input type="text"
				class="form-control" name="userId" maxlength="5" 　value="${userId}"
				disabled />
		</div>
		<div class="form-group pt-3">
			<label for="userName">氏名</label> <input type="text"
				class="form-control" name="userName" maxlength="50"
				value="${userName}" disabled />
		</div>
		<p>本日の体温を入力してください。</p>
		<p>なお、37.5℃以上ある場合は所属部門長へ連絡の上、欠席の手続きをしてください。</p>
		<input type="text" name="temperature" maxlength="4" /><label
